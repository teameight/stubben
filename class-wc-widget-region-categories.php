...
class WC_Widget_Region_Categories extends WP_Widget {
     ...
     * @return void
     */
    function WC_Widget_Region_Categories() {

        /* Widget variable settings. */
        $this->woo_widget_cssclass = 'woocommerce widget_region_categories';
        $this->woo_widget_description = __( 'A list or dropdown of region categories.', 'woocommerce' );
        $this->woo_widget_idbase = 'woocommerce_region_categories';
        $this->woo_widget_name = __( 'WooCommerce region Categories', 'woocommerce' );

        /* Widget settings. */
        $widget_ops = array( 'classname' => $this->woo_widget_cssclass, 'description' => $this->woo_widget_description );

        /* Create the widget. */
        $this->WP_Widget('region_categories', $this->woo_widget_name, $widget_ops);
    }
    ...
    function widget( $args, $instance ) {
        ...
        $title = apply_filters('widget_title', empty( $instance['title'] ) ? __( 'region Categories', 'woocommerce' ) : $instance['title'], $instance, $this->id_base);
        ...
        $cat_args = array( 'show_count' => $c, 'hierarchical' => $h, 'taxonomy' => 'region' );
        ...
        <?php
            ...
            if ( is_tax('region') ) {
                ...
                $this->cat_ancestors = get_ancestors( $this->current_cat->term_id, 'region' );

            } elseif ( is_singular('dealers') ) {

                $product_category = wc_get_product_terms( $post->ID, 'region', array( 'orderby' => 'parent' ) );
