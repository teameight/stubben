...
?>
            ...
            <div class="row-fluid">
                <div class="span12 a-center">
                    <?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
                        ...
                        <h1 class="title"><span>New Products</span></h1>
    ...
    <div class="container">
        <div class="page-content sidebar-position-<?php echo $position; ?> responsive-sidebar-<?php echo $responsive; ?>">
            ...
            <div class="row-fluid">
                <?php if($product_page_sidebar && ($position == 'left' || $responsive == 'top')): ?>
...
//                    var_dump($new);
                    ...
                    <?php if ( $new->have_posts() ) : ?>
                        ...
                        <?php $cats_displayed = woocommerce_product_subcategories(); ?>
                ...
                <?php if($product_page_sidebar && ($position == 'right' || $responsive == 'bottom')): ?>
